...
function search_tags_hook($hook, $type, $value, $params) {
	...
	$access = _elgg_get_access_where_sql(array('table_alias' => 'md', 'guid_column' => 'entity_guid'));
...
function search_comments_hook($hook, $type, $value, $params) {
	...
	$e_access = _elgg_get_access_where_sql();
	$a_access = _elgg_get_access_where_sql(array('table_alias' => 'a', 'guid_column' => 'entity_guid'));
