...
/**** INCLUDING DEPRECATED FUNCTION HERE UNTIL 1.9 *****/
...
function access_test($hook, $type, $value, $params) {
	...
	$value[] = $CONFIG->path . 'engine/tests/api/access_core_where_sql.php';
	$value[] = $CONFIG->path . 'engine/tests/api/access_where_sql.php';
	return $value;
}
